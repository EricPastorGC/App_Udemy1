...
namespace AppUdemy.Data.Migrations
{
    ...
    [Migration("20210510053653_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppUdemy.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppUdemy.Entities.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("AppUdemy.Entities.AppUserRole", b =>
                {
                    b.HasOne("AppUdemy.Entities.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppUdemy.Entities.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("AppUdemy.Entities.Message", b =>
                {
                    ...
                    b.HasOne("AppUdemy.Entities.AppUser", "Sender")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("AppUdemy.Entities.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("AppUdemy.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
